"""Generate debug_report.md — human-readable summary of the captured graph."""
...
def generate_debug_report(
    ...
    lines += ["# iphso-webgpu-export — Debug Report", ""]
...
def write_debug_report(
    ...
    report = generate_debug_report(ep, graph_data, weight_entries, manifest)
    (out_dir / "debug_report.md").write_text(report)
    return report
