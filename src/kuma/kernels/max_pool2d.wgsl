// aten.max_pool2d_with_indices.default — values only (the indices output has no consumer
// in an inference-only graph). NCHW layout; one invocation per output element.
...
fn main(
    ...
    var acc: f32 = -3.4028235e38; // -FLT_MAX
