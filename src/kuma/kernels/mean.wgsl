// aten.mean.dim — mean over a contiguous block of `reduce` elements (the reduced axes
// must be contiguous in memory, e.g. trailing dims or H,W in NCHW — true for every
// reduction pattern in the target model families).
